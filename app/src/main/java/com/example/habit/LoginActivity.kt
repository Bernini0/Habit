...
class LoginActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<View>(R.id.go_to_signup_text).setOnClickListener(this)

        mEdtEmail = findViewById(R.id.login_email_field)
        mEdtPassword = findViewById(R.id.login_password_field)
